...
This should not be interpreted as a limitation of these studies, but rather as a general challenge of the research question itself. Establishing a causal effect of the points system is extremely difficult because the rule change cannot be easily isolated from broader developments in the game. Football has continuously evolved over time, with changes in tactics, playing style, training methods, technology, and the physical performance of athletes. These developments may affect competitiveness and goal scoring independently of the points system, making a clean causal interpretation highly challenging.
